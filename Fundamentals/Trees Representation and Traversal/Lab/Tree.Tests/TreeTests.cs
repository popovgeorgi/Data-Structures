namespace Tree.Tests
{
    ...
    {
        private Node<int> tree;

        [SetUp]
        public void Setup()
        {
            this.tree = new Node<int>(7,
                new Node<int>(19,
                        new Node<int>(1),
                        new Node<int>(12),
                        new Node<int>(31)),
        ...
        {
            tree.AddChild(1, new Node<int>(-1, new Node<int>(-2), new Node<int>(-3)));
        ...
        public void TestAddChildSubtreeThrowsException()
        {
            Assert.Throws<ArgumentNullException>(()
                => tree.AddChild(77, new Node<int>(-1, new Node<int>(-2), new Node<int>(-3))));
        }
